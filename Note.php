			...
			if($opt=="sup"  ){
				...
				"<form enctype='multipart/form-data' method='post' action='".self::$ficherAction."' target='".self::$ficherIframe."' style=''>".
					...
					"<tr>".
						...
						"<td><select id='id_assujetti' name='id_assujetti'  class='".self::$input_class." option-id-assujetti' style='".self::$input_style."' ><option value=''>Choisir</option>" .Assujetti::options('',$id_assujetti)."</select></td>".
					"</tr>". 
					"<tr>".
